	...
	<view class="u-demo-block">
		<view style="margin-top: 20rpx;">
			<!-- 			<swiper :indicator-dots="true" class="swiper">
				<swiper-item> -->
			<u-search placeholder="输入要搜索的小程序" v-model="keyword"></u-search>
			<view style="margin-top: 40rpx;">
				<u-grid :border="false">
					<u-grid-item v-for="(item, index) in srcList" :index="index" :key="index"
			...
			<u-empty :mode="mode" :icon="imgList[mode]" :show="showSearchResult">
				<u-button size="small" type="primary" :style="{marginTop:10+'px'}" v-if="mode=='car'" text="查看更多小程序">
				</u-button>
			</u-empty>
			<!-- 				</swiper-item> -->
			<!-- 				<swiper-item>
	...
	export default {
		data() {
			...
			return {
				...
				srcList: ["https://s1.ax1x.com/2022/04/16/LYOiPP.jpg",
